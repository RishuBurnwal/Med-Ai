...
export default function ForgotPassword() {
  ...
  return (
    <div className="grid min-h-screen place-items-center p-6 fade-in" style={{ background: 'var(--bg-primary)' }}>
      <div className="card w-full max-w-md p-8">
        <div className="mx-auto grid h-16 w-16 place-items-center rounded-2xl" style={{ background: 'var(--accent)' }}>
          ...
          <div className="mt-6 space-y-4">
            ...
            {token && (
              <div className="rounded-lg border p-3 text-xs" style={{ borderColor: 'var(--border)', background: 'var(--bg-secondary)' }}>
                ...
                <button
                  className="mt-2 text-emerald-400 hover:underline block"
          ...
          <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
            <label className="block text-sm">
              ...
              <input className="input mt-2 w-full" type="email" required value={email}
                onChange={e => setEmail(e.target.value)} placeholder="patient@example.com" />
            </label>
        ...
        <div className="mt-6 text-center">
          <Link to="/login" className="inline-flex items-center gap-1 text-sm text-emerald-400 hover:underline">
